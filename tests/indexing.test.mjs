...
test('public indexing includes commercial routes and only releasable inventory', () => {
  ...
  assert.ok(urls.includes('https://aerotrade.app/used-hot-air-balloons-for-sale'))
  assert.ok(urls.includes('https://aerotrade.app/de/gebrauchte-heissluftballons'))
  assert.ok(urls.includes('https://aerotrade.app/fr/montgolfieres-occasion'))
  assert.ok(urls.includes('https://aerotrade.app/es/globos-aerostaticos-segunda-mano'))
