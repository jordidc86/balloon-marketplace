...
comment on constraint commercial_notification_receipts_notification_type_check on public.commercial_notification_receipts is
  'Closed vocabulary for transactional commercial delivery receipts. listing_availability_request asks an existing seller to reconfirm a live advert; it never changes listing state.';
