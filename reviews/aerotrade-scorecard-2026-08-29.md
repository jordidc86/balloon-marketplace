...
- 43 automated tests, 47 operational contracts, lint, production build and dependency audit.
...
| 12 | Production, deployment, persistence, tests and recovery | 88% | 94% | Main branch consolidation discipline, migrations registered and read back, public route health, protected-route enforcement, 43 tests and 47 contracts. | Synthetic monitoring is not yet exercising a full safe commercial transaction; Next.js reports an Edge runtime deprecation warning. |
