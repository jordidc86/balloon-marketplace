...
4. **Prove one complete commercial journey.** The grouped candidate now provides four high-intent European entries that reuse current inventory and preserve external attribution. Target one genuine watch, enquiry, wanted request or new-balloon request progressing to a stored response. No synthetic event counts or readiness increase is claimed from the pages alone.
