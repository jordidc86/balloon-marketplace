  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-16 sm:py-24">
      ...
      <div className="prose prose-slate dark:prose-invert lg:prose-lg max-w-none">
        ...
        <p>When you register for an AeroTrade account, we collect your name, email address, and optionally your phone number. When you submit an enquiry, we store the contact details and message you provide, the listing concerned, delivery evidence and the commercial status recorded by the seller or AeroTrade. When you subscribe to Premium or pay for Premium listing promotion, your payment information is processed by Stripe; we do not store your card details on our servers.</p>
