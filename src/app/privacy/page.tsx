  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-16 sm:py-24">
      ...
      <div className="prose prose-slate dark:prose-invert lg:prose-lg max-w-none">
        ...
        <p>When you register for an AeroTrade account, we collect your name, email address, and optionally your phone number. When you submit an enquiry, record wanted equipment or request help preparing a sale, we store the contact details, requirements, consent choices, relevant listing or equipment category, delivery evidence and commercial status. Assisted-sale requests remain private and do not create or publish a listing. When you subscribe to Premium or pay for Premium listing promotion, your payment information is processed by Stripe; we do not store your card details on our servers. We retain a private checkout-status record so an interrupted Premium checkout can be resumed without creating another account; it contains no card data or checkout URL.</p>
