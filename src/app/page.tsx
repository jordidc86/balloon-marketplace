          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {listings?.length === 0 && (
              <div className="col-span-full py-20 text-center flex flex-col items-center bg-white rounded-2xl border border-dashed border-slate-300">
                ...
                <div className="flex flex-col gap-3 sm:flex-row"><Link href="/new-balloon?source=catalog-empty" className="bg-primary hover:bg-primary/90 text-white font-medium px-6 py-2.5 rounded-full transition-colors shadow-sm">Get an Approximate New-Balloon Budget</Link><Link href="/wanted" className="border border-slate-300 bg-white px-6 py-2.5 rounded-full font-medium text-slate-700 hover:border-primary hover:text-primary">Tell Us What You Need</Link></div>
              </div>
            )}
          </div>
